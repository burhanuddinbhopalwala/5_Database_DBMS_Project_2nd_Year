...
if (isset($_SESSION['login']))
{
	...
	echo "<h3>Hi ".$_SESSION['login']."</h3>";   //NOT WORKING SOMETIMES THESE 2 LINES .
  ...
  <tr>
    <td width="7%" height="65" valign="bottom"><img src="images/micro.jpg" width="50" height="50" align="middle"></td>
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
      ...
      <span class="style5"><img src="images/paathshala.jpg" width="129" height="100"><span class="style7"><img src="images/book.jpg" width="50" height="50"><img src="images/micro.jpg" width="43" height="43"></span>        </span>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      <table width="200" border="0">
        ...
        <tr>
		  ...
		  <tr>
          <td colspan="2" bgcolor="khaki"><div align="center"><span class="style4">Admin Login Here : <a href="admin/index.php">Admin</a></span></div></td>
          </tr>
     
      </table>
      <div align="center">
        <p class="style5"><img src="images/bottomright.jpg" width="134" height="128">          </p>
        </div>
    </form></td>
  </tr>
</table>
